...
import 'restaurantOwnerSettingsScreen.dart';
...
class RestaurantHomepage extends StatefulWidget {
  ...
  RestaurantHomepage({required this.restaurantID});
  
  //const RestaurantHomepage({super.key});

  @override
  State<StatefulWidget> createState() => RestaurantHomepageState();
}
          ...
          appBar: RestaurantPageAppBar(
            ...
            onShareButtonPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        RestaurantOwnerSettingsScreen(data:data)),
              );
            },
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  RestaurantPageBar(name : data['name'], 
                  ...
                  Container(
                    child: RestaurantPageScrollButtons(
                      onPhotosTap: () {
                        ...
                        Scrollable.ensureVisible(_photosKey.currentContext!,
                            duration: const Duration(milliseconds: 1000));
                      },
                      onMenuTap: () {
                        //_scrollController.scrollTo(key: _menuKey);
                        Scrollable.ensureVisible(_menuKey.currentContext!,
                            duration: const Duration(milliseconds: 1000));
                      },
                      onReviewsTap: () {
                        //_scrollController.scrollTo(key: _reviewsKey);
                        Scrollable.ensureVisible(_reviewsKey.currentContext!,
                            duration: const Duration(milliseconds: 1000));
                      },
                      onAboutTap: () {
                  ...
                  RestaurantPageRecommendations(restaurantDetailsList),
                  SizedBox(height: 16),
                  RestaurantPageError(),
                  ElevatedButton(
                    onPressed: () {
